    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			div2 = element("div");
    			div2.textContent = "A website that people can use to communicate and make a club for school.";
    			t8 = space();
    			div3 = element("div");
    			...
    			add_location(div1, file$4, 17, 2, 639);
    			attr_dev(div2, "class", "home_description");
    			add_location(div2, file$4, 20, 2, 705);
    			attr_dev(div3, "class", "home_button");
    			attr_dev(div3, "onclick", "document.getElementById('home_detail').scrollIntoView();");
    			add_location(div3, file$4, 23, 2, 826);
    			attr_dev(div4, "class", "home_inner");
    			add_location(div4, file$4, 16, 1, 611);
    			attr_dev(div5, "class", "home_image");
    			add_location(div5, file$4, 15, 0, 584);
    			add_location(h1, file$4, 30, 2, 1013);
    			attr_dev(div6, "class", "details");
    			add_location(div6, file$4, 29, 1, 988);
    			...
    			attr_dev(img1, "alt", "...");
    			add_location(img1, file$4, 37, 5, 1141);
    			attr_dev(h50, "class", "card-title");
    			add_location(h50, file$4, 43, 6, 1377);
    			attr_dev(p0, "class", "card-text");
    			add_location(p0, file$4, 44, 6, 1419);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "btn btn-outline-primary");
    			add_location(button0, file$4, 49, 7, 1579);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-outline-primary");
    			add_location(button1, file$4, 53, 7, 1683);
    			attr_dev(div7, "class", "button-group");
    			add_location(div7, file$4, 48, 6, 1544);
    			attr_dev(div8, "class", "card-body");
    			add_location(div8, file$4, 42, 5, 1346);
    			attr_dev(div9, "class", "card_list");
    			add_location(div9, file$4, 36, 4, 1111);
    			add_location(tr0, file$4, 35, 3, 1101);
    			...
    			attr_dev(img2, "alt", "...");
    			add_location(img2, file$4, 63, 5, 1873);
    			attr_dev(h51, "class", "card-title");
    			add_location(h51, file$4, 69, 6, 2109);
    			attr_dev(p1, "class", "card-text");
    			add_location(p1, file$4, 70, 6, 2151);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-outline-primary");
    			add_location(button2, file$4, 75, 7, 2311);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "btn btn-outline-primary");
    			add_location(button3, file$4, 79, 7, 2415);
    			attr_dev(div10, "class", "button-group");
    			add_location(div10, file$4, 74, 6, 2276);
    			attr_dev(div11, "class", "card-body");
    			add_location(div11, file$4, 68, 5, 2078);
    			attr_dev(div12, "class", "card_list");
    			add_location(div12, file$4, 62, 4, 1843);
    			add_location(tr1, file$4, 61, 3, 1833);
    			...
    			attr_dev(img3, "alt", "...");
    			add_location(img3, file$4, 89, 5, 2605);
    			attr_dev(h52, "class", "card-title");
    			add_location(h52, file$4, 95, 6, 2841);
    			attr_dev(p2, "class", "card-text");
    			add_location(p2, file$4, 96, 6, 2883);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "btn btn-outline-primary");
    			add_location(button4, file$4, 101, 7, 3043);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "btn btn-outline-primary");
    			add_location(button5, file$4, 105, 7, 3147);
    			attr_dev(div13, "class", "button-group");
    			add_location(div13, file$4, 100, 6, 3008);
    			attr_dev(div14, "class", "card-body");
    			add_location(div14, file$4, 94, 5, 2810);
    			attr_dev(div15, "class", "card_list");
    			add_location(div15, file$4, 88, 4, 2575);
    			add_location(tr2, file$4, 87, 3, 2565);
    			...
    			attr_dev(img4, "alt", "...");
    			add_location(img4, file$4, 115, 5, 3337);
    			attr_dev(h53, "class", "card-title");
    			add_location(h53, file$4, 121, 6, 3573);
    			attr_dev(p3, "class", "card-text");
    			add_location(p3, file$4, 122, 6, 3615);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "btn btn-outline-primary");
    			add_location(button6, file$4, 127, 7, 3775);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "btn btn-outline-primary");
    			add_location(button7, file$4, 131, 7, 3879);
    			attr_dev(div16, "class", "button-group");
    			add_location(div16, file$4, 126, 6, 3740);
    			attr_dev(div17, "class", "card-body");
    			add_location(div17, file$4, 120, 5, 3542);
    			attr_dev(div18, "class", "card_list");
    			add_location(div18, file$4, 114, 4, 3307);
    			add_location(tr3, file$4, 113, 3, 3297);
    			...
    			attr_dev(img5, "alt", "...");
    			add_location(img5, file$4, 141, 5, 4069);
    			attr_dev(h54, "class", "card-title");
    			add_location(h54, file$4, 147, 6, 4305);
    			attr_dev(p4, "class", "card-text");
    			add_location(p4, file$4, 148, 6, 4347);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "btn btn-outline-primary");
    			add_location(button8, file$4, 153, 7, 4507);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "btn btn-outline-primary");
    			add_location(button9, file$4, 157, 7, 4611);
    			attr_dev(div19, "class", "button-group");
    			add_location(div19, file$4, 152, 6, 4472);
    			attr_dev(div20, "class", "card-body");
    			add_location(div20, file$4, 146, 5, 4274);
    			attr_dev(div21, "class", "card_list");
    			add_location(div21, file$4, 140, 4, 4039);
    			add_location(tr4, file$4, 139, 3, 4029);
    			add_location(table, file$4, 34, 2, 1089);
    			set_style(div22, "overflow", "scroll");
    			set_style(div22, "height", "100%");
    			add_location(div22, file$4, 33, 1, 1043);
    			attr_dev(div23, "id", "home_detail");
    			add_location(div23, file$4, 28, 0, 963);
