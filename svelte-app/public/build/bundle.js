    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			p0 = element("p");
    			p0.textContent = "This is a awsome Club A. We have wonderful things\r\n\t\t\t\t\t\t\tand unique ideas.";
    			t12 = space();
    			div3 = element("div");
    			...
    			t19 = space();
    			p1 = element("p");
    			p1.textContent = "This is a awsome Club B. We have wonderful things\r\n\t\t\t\t\t\t\tand unique ideas.";
    			t21 = space();
    			div6 = element("div");
    			...
    			t28 = space();
    			p2 = element("p");
    			p2.textContent = "This is a awsome Club C. We have wonderful things\r\n\t\t\t\t\t\t\tand unique ideas.";
    			t30 = space();
    			div9 = element("div");
    			...
    			t37 = space();
    			p3 = element("p");
    			p3.textContent = "This is a awsome Club D. We have wonderful things\r\n\t\t\t\t\t\t\tand unique ideas.";
    			t39 = space();
    			div12 = element("div");
    			...
    			t46 = space();
    			p4 = element("p");
    			p4.textContent = "This is a awsome Club E. We have wonderful things\r\n\t\t\t\t\t\t\tand unique ideas.";
    			t48 = space();
    			div15 = element("div");
    			...
    			add_location(img0, file$4, 9, 6, 312);
    			add_location(li0, file$4, 9, 2, 308);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "nav-link px-2 text-black");
    			set_style(a0, "font-weight", "bold");
    			add_location(a0, file$4, 10, 6, 389);
    			add_location(li1, file$4, 10, 2, 385);
    			attr_dev(a1, "href", "/mypage");
    			attr_dev(a1, "class", "nav-link px-2 text-secondary");
    			add_location(a1, file$4, 11, 6, 482);
    			add_location(li2, file$4, 11, 2, 478);
    			attr_dev(ul, "class", "nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-start mb-md-0");
    			add_location(ul, file$4, 8, 3, 223);
    			set_style(div0, "height", "auto");
    			add_location(div0, file$4, 7, 1, 191);
    			attr_dev(header, "class", "p-3");
    			set_style(header, "height", "100px");
    			add_location(header, file$4, 6, 0, 145);
    			if (!src_url_equal(img1.src, img1_src_value = 'images/club.jpg')) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "club");
    			attr_dev(img1, "class", "home_image");
    			add_location(img1, file$4, 16, 1, 592);
    			add_location(div1, file$4, 15, 0, 584);
    			add_location(h1, file$4, 21, 2, 699);
    			attr_dev(div2, "class", "details");
    			add_location(div2, file$4, 20, 1, 674);
    			...
    			attr_dev(img2, "alt", "...");
    			add_location(img2, file$4, 28, 5, 827);
    			attr_dev(h50, "class", "card-title");
    			add_location(h50, file$4, 34, 6, 1063);
    			attr_dev(p0, "class", "card-text");
    			add_location(p0, file$4, 35, 6, 1105);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "btn btn-outline-primary");
    			add_location(button0, file$4, 40, 7, 1265);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-outline-primary");
    			add_location(button1, file$4, 44, 7, 1369);
    			attr_dev(div3, "class", "button-group");
    			add_location(div3, file$4, 39, 6, 1230);
    			attr_dev(div4, "class", "card-body");
    			add_location(div4, file$4, 33, 5, 1032);
    			attr_dev(div5, "class", "card_list");
    			add_location(div5, file$4, 27, 4, 797);
    			add_location(tr0, file$4, 26, 3, 787);
    			...
    			attr_dev(img3, "alt", "...");
    			add_location(img3, file$4, 54, 5, 1559);
    			attr_dev(h51, "class", "card-title");
    			add_location(h51, file$4, 60, 6, 1795);
    			attr_dev(p1, "class", "card-text");
    			add_location(p1, file$4, 61, 6, 1837);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-outline-primary");
    			add_location(button2, file$4, 66, 7, 1997);
    			attr_dev(button3, "type", "button");
    			attr_dev(button3, "class", "btn btn-outline-primary");
    			add_location(button3, file$4, 70, 7, 2101);
    			attr_dev(div6, "class", "button-group");
    			add_location(div6, file$4, 65, 6, 1962);
    			attr_dev(div7, "class", "card-body");
    			add_location(div7, file$4, 59, 5, 1764);
    			attr_dev(div8, "class", "card_list");
    			add_location(div8, file$4, 53, 4, 1529);
    			add_location(tr1, file$4, 52, 3, 1519);
    			...
    			attr_dev(img4, "alt", "...");
    			add_location(img4, file$4, 80, 5, 2291);
    			attr_dev(h52, "class", "card-title");
    			add_location(h52, file$4, 86, 6, 2527);
    			attr_dev(p2, "class", "card-text");
    			add_location(p2, file$4, 87, 6, 2569);
    			attr_dev(button4, "type", "button");
    			attr_dev(button4, "class", "btn btn-outline-primary");
    			add_location(button4, file$4, 92, 7, 2729);
    			attr_dev(button5, "type", "button");
    			attr_dev(button5, "class", "btn btn-outline-primary");
    			add_location(button5, file$4, 96, 7, 2833);
    			attr_dev(div9, "class", "button-group");
    			add_location(div9, file$4, 91, 6, 2694);
    			attr_dev(div10, "class", "card-body");
    			add_location(div10, file$4, 85, 5, 2496);
    			attr_dev(div11, "class", "card_list");
    			add_location(div11, file$4, 79, 4, 2261);
    			add_location(tr2, file$4, 78, 3, 2251);
    			...
    			attr_dev(img5, "alt", "...");
    			add_location(img5, file$4, 106, 5, 3023);
    			attr_dev(h53, "class", "card-title");
    			add_location(h53, file$4, 112, 6, 3259);
    			attr_dev(p3, "class", "card-text");
    			add_location(p3, file$4, 113, 6, 3301);
    			attr_dev(button6, "type", "button");
    			attr_dev(button6, "class", "btn btn-outline-primary");
    			add_location(button6, file$4, 118, 7, 3461);
    			attr_dev(button7, "type", "button");
    			attr_dev(button7, "class", "btn btn-outline-primary");
    			add_location(button7, file$4, 122, 7, 3565);
    			attr_dev(div12, "class", "button-group");
    			add_location(div12, file$4, 117, 6, 3426);
    			attr_dev(div13, "class", "card-body");
    			add_location(div13, file$4, 111, 5, 3228);
    			attr_dev(div14, "class", "card_list");
    			add_location(div14, file$4, 105, 4, 2993);
    			add_location(tr3, file$4, 104, 3, 2983);
    			if (!src_url_equal(img6.src, img6_src_value = "https://m.media-amazon.com/images/M/MV5BNDc4OGU0MGYtODdlYy00ODZmLTgxMmMtM2QyNzM3Y2VhZjViXkEyXkFqcGdeQXVyNTMyMzg4ODA@._V1_.jpg")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "class", "img-thumbnail");
    			attr_dev(img6, "alt", "...");
    			add_location(img6, file$4, 132, 5, 3755);
    			attr_dev(h54, "class", "card-title");
    			add_location(h54, file$4, 138, 6, 3991);
    			attr_dev(p4, "class", "card-text");
    			add_location(p4, file$4, 139, 6, 4033);
    			attr_dev(button8, "type", "button");
    			attr_dev(button8, "class", "btn btn-outline-primary");
    			add_location(button8, file$4, 144, 7, 4193);
    			attr_dev(button9, "type", "button");
    			attr_dev(button9, "class", "btn btn-outline-primary");
    			add_location(button9, file$4, 148, 7, 4297);
    			attr_dev(div15, "class", "button-group");
    			add_location(div15, file$4, 143, 6, 4158);
    			attr_dev(div16, "class", "card-body");
    			add_location(div16, file$4, 137, 5, 3960);
    			attr_dev(div17, "class", "card_list");
    			add_location(div17, file$4, 131, 4, 3725);
    			add_location(tr4, file$4, 130, 3, 3715);
    			add_location(table, file$4, 25, 2, 775);
    			set_style(div18, "overflow", "scroll");
    			set_style(div18, "height", "100%");
    			add_location(div18, file$4, 24, 1, 729);
    			add_location(div19, file$4, 18, 0, 664);
    			add_location(body, file$4, 5, 0, 137);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
